...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AAPL | active but stale-before-live-use | 12-24 months | medium business quality / low new actionability | 2026-07-31 thesis ledger; case refresh on next earnings | next quarterly results / guidance update | watch_only / no_action | `memory/research/AAPL/thesis-ledger.md`; `cases/aapl-2026-04/actionability-bridge.md` |
...
| CRWV | upgrade_watch candidate | 6-18 months | medium demand / low financing clarity | 2026-08-15 or next quarterly update | Q2 results; financing/capex update | watch_only pending financing clarity | `cases/crwv-2026-05/event-delta.md` |
